...
class CartUtils():
    ...
    def build_srv_cmd(self, cartobj, urifile, env):
        ...
        srvcmd = "{} --mca btl self,tcp --report-uri {} -N {} -H {} ".format(orterun_bin, urifile, srv_ppn, srv_host)
    ...
    def build_cli_cmd(self, cartobj, urifile, env):
        ...
        clicmd = "{} --mca btl self,tcp --ompi-server file:{} -N {} -H {} ".format(orterun_bin, urifile, cli_ppn, cli_host)
    ...
    def build_cmd(self, cartobj, env):
        ...
        host = cartobj.params.get("testhost", '/run/hosts/*/')
        ...
        cmd = "{} --mca btl self,tcp -N {} -H {} ".format(orterun_bin, tst_ppn, host)
        cmd += env
        cmd += tst_ctx
        cmd += tst_env
        cmd += tst_bin
